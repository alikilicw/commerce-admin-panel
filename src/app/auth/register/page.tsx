...
import enumToOptions from '@/util/enum-to-object'
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div className="flex flex-wrap items-center">
                    ...
                    <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <div className="w-full p-4 sm:px-12.5 sm:py-3 xl:px-17.5 xl:py-5">
                            <h2 className="mb-4 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                                Register to TailAdmin
                            </h2>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    <label className="mb-2.5 block font-medium text-black dark:text-white">Phone</label>
                                    <div className="relative">
                                        <input
                                            name="phone"
                                            onChange={handleChange}
